  ...
  return (function(t) {
    ...
    function(t, e, n) {
      (function(e) {
        ...
        function r(t, n) {
          var r = t;
          (n = n || e.location), null == t &&
            (t = n.protocol + "//" + n.host), "string" == typeof t &&
            (
              "/" === t.charAt(0) &&
            ...
            (/^(http|ws)$/.test(r.protocol)
              ? (r.port = "80")
              : /^(http|ws)s$/.test(r.protocol) && (r.port = "443")), (r.path =
            r.path || "/");
          var s = r.host.indexOf(":") !== -1,
            a = s ? "[" + r.host + "]" : r.host;
          return (r.id = r.protocol + "://" + a + ":" + r.port), (r.href =
            r.protocol +
            "://" +
            a +
            (n && n.port === r.port ? "" : ":" + r.port)), r;
        }
        var o = n(2),
    ...
    function(t, e, n) {
      (function(r) {
        ...
        (e = t.exports = n(
          5
        )), (e.log = s), (e.formatArgs = i), (e.save = a), (e.load = c), (e.useColors = o), (e.storage =
    ...
    function(t, e) {
      ...
      (f.nextTick = function(t) {
        ...
        ""), (f.versions = {}), (f.on = p), (f.addListener = p), (f.once = p), (f.off = p), (f.removeListener = p), (f.removeAllListeners = p), (f.emit = p), (f.prependListener = p), (f.prependOnceListener = p), (f.listeners = function(
        t
      ) {
        return [];
    ...
    function(t, e, n) {
      ...
      function o(t) {
        ...
        return (n.namespace = t), (n.enabled = e.enabled(
          t
        )), (n.useColors = e.useColors()), (n.color = r(t)), "function" ==
          typeof e.init && e.init(n), n;
      }
      function i(t) {
      ...
      (e = t.exports = o.debug = o[
        "default"
      ] = o), (e.coerce = c), (e.disable = s), (e.enable = i), (e.enabled = a), (e.humanize = n(
        6
    ...
    function(t, e, n) {
      ...
      (e.protocol = 4), (e.types = [
        ...
        "BINARY_EVENT",
        "BINARY_ACK"
      ]), (e.CONNECT = 0), (e.DISCONNECT = 1), (e.EVENT = 2), (e.ACK = 3), (e.ERROR = 4), (e.BINARY_EVENT = 5), (e.BINARY_ACK = 6), (e.Encoder = r), (e.Decoder = s), (r.prototype.encode = function(
        t,
        n
      ) {
        if (
        ...
        var n;
        if ("string" == typeof t)
          (n = a(t)), e.BINARY_EVENT === n.type || e.BINARY_ACK === n.type
            ? (
          ...
          (n = this.reconstructor.takeBinaryData(t)), n &&
    ...
    function(t, e, n) {
      ...
      (t.exports = r), (r.prototype.on = r.prototype.addEventListener = function(
        t,
        e
      ) {
    ...
    function(t, e, n) {
      ...
      function r(t, e) {
        ...
        t &&
          ...
          "closed"), (this.uri = t), (this.connecting = []), (this.lastPing = null), (this.encoding = !1), (this.packetBuffer = []);
        var n = e.parser || c;
        (this.encoder = new n.Encoder()), (this.decoder = new n.Decoder()), (this.autoConnect =
          e.autoConnect !== !1), this.autoConnect && this.open();
      }
      var o =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function(t) {
      ...
      (t.exports = r), (r.prototype.emitAll = function() {
        ...
        if (!1 !== this._timeout) {
          ...
          var c = setTimeout(function() {
            h(
              ...
              a
            ), o.destroy(), n.close(), n.emit("error", "timeout"), r.emitAll("connect_timeout", a);
          }, a);
          this.subs.push({
            destroy: function() {
              clearTimeout(c);
        ...
        h("open"), this.cleanup(), (this.readyState = "open"), this.emit(
          "open"
        );
        var t = this.engine;
        this.subs.push(p(t, "data", u(this, "ondata"))), this.subs.push(
          p(t, "ping", u(this, "onping"))
        ), this.subs.push(p(t, "pong", u(this, "onpong"))), this.subs.push(
          p(t, "error", u(this, "onerror"))
        ), this.subs.push(p(t, "close", u(this, "onclose"))), this.subs.push(
        ...
        ~e && this.connecting.splice(e, 1), this.connecting.length ||
          this.close();
      }), (r.prototype.packet = function(t) {
        h("writing packet %j", t);
        var e = this;
        t.query && 0 === t.type && (t.nsp += "?" + t.query), e.encoding
        ...
        h(
          "disconnect"
        ), (this.skipReconnect = !0), (this.reconnecting = !1), "opening" ===
          this.readyState &&
          this.cleanup(), this.backoff.reset(), (this.readyState =
          "closed"), this.engine && this.engine.close();
      }), (r.prototype.onclose = function(t) {
        h("onclose"), this.cleanup(), this.backoff.reset(), (this.readyState =
          "closed"), this.emit("close", t), this._reconnection &&
          !this.skipReconnect &&
          this.reconnect();
        ...
        if (this.backoff.attempts >= this._reconnectionAttempts)
          h("reconnect failed"), this.backoff.reset(), this.emitAll(
            "reconnect_failed"
          ), (this.reconnecting = !1);
        else {
    ...
    function(t, e, n) {
      (function(e) {
        function r(t, n) {
          ...
          (n = n || {}), t && "object" == typeof t && ((n = t), (t = null)), t
            ? (
                (t = u(t)),
                (n.hostname = t.host),
            ...
            : n.host && (n.hostname = u(n.host).host), (this.secure =
            null != n.secure
              ? n.secure
              : e.location && "https:" === location.protocol), n.hostname &&
            !n.port &&
            (n.port = this.secure ? "443" : "80"), (this.agent =
            n.agent || !1), (this.hostname =
            n.hostname ||
            (e.location ? location.hostname : "localhost")), (this.port =
            n.port ||
            (e.location && location.port
              ? location.port
              : this.secure ? 443 : 80)), (this.query =
            n.query || {}), "string" == typeof this.query &&
            (this.query = f.decode(this.query)), (this.upgrade =
            !1 !== n.upgrade), (this.path =
            (n.path || "/engine.io").replace(/\/$/, "") +
            "/"), (this.forceJSONP = !!n.forceJSONP), (this.jsonp =
            !1 !==
            n.jsonp), (this.forceBase64 = !!n.forceBase64), (this.enablesXDR = !!n.enablesXDR), (this.timestampParam =
            ...
            ""), (this.writeBuffer = []), (this.prevBufferLen = 0), (this.policyPort =
            n.policyPort || 843), (this.rememberUpgrade =
            n.rememberUpgrade ||
            !1), (this.binaryType = null), (this.onlyBinaryUpgrades =
            n.onlyBinaryUpgrades), (this.perMessageDeflate =
            !1 !== n.perMessageDeflate && (n.perMessageDeflate || {})), !0 ===
            this.perMessageDeflate && (this.perMessageDeflate = {}), this
            .perMessageDeflate &&
            null == this.perMessageDeflate.threshold &&
            (this.perMessageDeflate.threshold = 1024), (this.pfx =
            n.pfx || null), (this.key = n.key || null), (this.passphrase =
            n.passphrase || null), (this.cert = n.cert || null), (this.ca =
            n.ca || null), (this.ciphers =
            n.ciphers || null), (this.rejectUnauthorized =
        ...
        var i = n(17),
          ...
          h = n(38),
          f = n(31);
        (t.exports = r), (r.priorWebsocketSuccess = !1), s(
          r.prototype
        ), (r.protocol = p.protocol), (r.Socket = r), (r.Transport = n(
          22
        )), (r.transports = n(17)), (r.parser = n(
          23
          ...
          function p() {
            u.removeListener("open", e), u.removeListener(
              "error",
              o
            ), u.removeListener("close", i), f.removeListener(
              "close",
              s
          ...
          var u = this.createTransport(t, { probe: 1 }),
            h = !1,
            f = this;
          (r.priorWebsocketSuccess = !1), u.once("open", e), u.once(
            "error",
            o
          ), u.once("close", i), this.once("close", s), this.once(
            "upgrading",
            c
          ), u.open();
        }), (r.prototype.onOpen = function() {
          ...
          this.emit("handshake", t), (this.id =
            t.sid), (this.transport.query.sid =
            t.sid), (this.upgrades = this.filterUpgrades(
            t.upgrades
          )), (this.pingInterval = t.pingInterval), (this.pingTimeout =
            t.pingTimeout), this.onOpen(), "closed" !== this.readyState &&
            (
              this.setPing(),
          ...
          this.writeBuffer.splice(
            0,
            this.prevBufferLen
          ), (this.prevBufferLen = 0), 0 === this.writeBuffer.length
            ? this.emit("drain")
            : this.flush();
          ...
          if (
            ...
            this.emit("packetCreate", o), this.writeBuffer.push(o), r &&
              this.once("flush", r), this.flush();
          }
          ...
          function e() {
            r.removeListener("upgrade", e), r.removeListener(
              "upgradeError",
              e
            ), t();
          }
          ...
          a("socket error %j", t), (r.priorWebsocketSuccess = !1), this.emit(
            "error",
            t
          ...
          if (
            ...
            var n = this;
            clearTimeout(this.pingIntervalTimer), clearTimeout(
              this.pingTimeoutTimer
            ), this.transport.removeAllListeners(
              "close"
            ), this.transport.close(), this.transport.removeAllListeners(), (this.readyState =
              "closed"), (this.id = null), this.emit(
              "close",
              t,
              e
        ...
        function r(e) {
          ...
          if (t.location) {
            var p = "https:" === location.protocol,
              u = location.port;
            u || (u = p ? 443 : 80), (r =
              e.hostname !== location.hostname || u !== e.port), (a =
              e.secure !== p);
          }
          if (
            (
    ...
    function(t, e, n) {
      (function(e) {
        ...
        function o(t) {
          if (
            ...
            var n = "https:" === location.protocol,
              r = location.port;
            r || (r = n ? 443 : 80), (this.xd =
              t.hostname !== e.location.hostname || r !== t.port), (this.xs =
              t.secure !== n);
          }
        }
        function i(t) {
          (this.method = t.method || "GET"), (this.uri =
            t.uri), (this.xd = !!t.xd), (this.xs = !!t.xs), (this.async =
            !1 !== t.async), (this.data =
            void 0 !== t.data ? t.data : null), (this.agent =
            t.agent), (this.isBinary = t.isBinary), (this.supportsBinary =
            t.supportsBinary), (this.enablesXDR =
            t.enablesXDR), (this.requestTimeout = t.requestTimeout), (this.pfx =
            t.pfx), (this.key = t.key), (this.passphrase =
            t.passphrase), (this.cert = t.cert), (this.ca =
            t.ca), (this.ciphers = t.ciphers), (this.rejectUnauthorized =
            t.rejectUnauthorized), (this.extraHeaders =
        ...
        (t.exports = o), (t.exports.Request = i), u(
          o,
          c
          ...
          return (t =
            t ||
            {}), (t.uri = this.uri()), (t.xd = this.xd), (t.xs = this.xs), (t.agent =
            this.agent ||
            !1), (t.supportsBinary = this.supportsBinary), (t.enablesXDR = this.enablesXDR), (t.pfx = this.pfx), (t.key = this.key), (t.passphrase = this.passphrase), (t.cert = this.cert), (t.ca = this.ca), (t.ciphers = this.ciphers), (t.rejectUnauthorized = this.rejectUnauthorized), (t.requestTimeout = this.requestTimeout), (t.extraHeaders = this.extraHeaders), new i(
            t
          );
          ...
          var n = (this.xhr = new a(t)),
            r = this;
          try {
            h("xhr open %s: %s", this.method, this.uri), n.open(
              this.method,
              this.uri,
              this.async
            );
            ...
            "withCredentials" in n && (n.withCredentials = !0), this
              .requestTimeout &&
              (n.timeout = this.requestTimeout), this.hasXDR()
              ? (
                  (n.onload = function() {
                    r.onLoad();
                  }),
          ...
          this.cleanup();
        }), (i.requestsCount = 0), (i.requests = {}), e.document &&
          (e.attachEvent
    ...
    function(t, e, n) {
      ...
      a(r, o), (r.prototype.name =
        "polling"), (r.prototype.doOpen = function() {
        this.poll();
        ...
        var n = function(t, n, r) {
          return "opening" === e.readyState && e.onOpen(), "close" === t.type
            ? (e.onClose(), !1)
            : void e.onPacket(t);
        };
        s.decodePayload(t, this.socket.binaryType, n), "closed" !==
          this.readyState &&
          (
            (this.polling = !1),
        ...
        var t = this.query || {},
          ...
          n = "";
        !1 !== this.timestampRequests && (t[this.timestampParam] = c()), this
          .supportsBinary ||
          t.sid ||
          (t.b64 = 1), (t = i.encode(t)), this.port &&
    ...
    function(t, e, n) {
      function r(t) {
        (this.path = t.path), (this.hostname = t.hostname), (this.port =
          t.port), (this.secure = t.secure), (this.query =
          t.query), (this.timestampParam =
          t.timestampParam), (this.timestampRequests =
          t.timestampRequests), (this.readyState = ""), (this.agent =
          t.agent || !1), (this.socket = t.socket), (this.enablesXDR =
          t.enablesXDR), (this.pfx = t.pfx), (this.key =
          t.key), (this.passphrase = t.passphrase), (this.cert =
          t.cert), (this.ca = t.ca), (this.ciphers =
          t.ciphers), (this.rejectUnauthorized =
          t.rejectUnauthorized), (this.forceNode =
          t.forceNode), (this.extraHeaders =
          t.extraHeaders), (this.localAddress = t.localAddress);
      }
      var o = n(23),
        i = n(8);
      (t.exports = r), i(r.prototype), (r.prototype.onError = function(t, e) {
        var n = new Error(t);
        return (n.type = "TransportError"), (n.description = e), this.emit(
          "error",
          n
        ), this;
      }), (r.prototype.open = function() {
    ...
    function(t, e, n) {
      (function(t) {
        ...
        (e.encodePacket = function(e, n, i, a) {
          "function" == typeof n && ((a = n), (n = !1)), "function" ==
            typeof i && ((a = i), (i = null));
            ...
            ? void c(t, r, function(t, e) {
                var r = e.reduce(function(t, e) {
                    ...
                    return (n =
                      "string" == typeof e
                        ? e.length
                        : e.byteLength), t + n.toString().length + n + 2;
                  }, 0),
                  o = new Uint8Array(r),
                  i = 0;
      ...
      !(function() {
        ...
        (e.encode = function(e) {
          ...
          for (n = 0; n < o; n += 3)
            (i += t[r[n] >> 2]), (i +=
              t[((3 & r[n]) << 4) | (r[n + 1] >> 4)]), (i +=
              t[((15 & r[n + 1]) << 2) | (r[n + 2] >> 6)]), (i +=
              t[63 & r[n + 2]]);
          return o % 3 === 2
            ? (i = i.substring(0, i.length - 1) + "=")
            : o % 3 === 1 && (i = i.substring(0, i.length - 2) + "=="), i;
        }), (e.decode = function(t) {
          var e,
            r,
            o,
          ...
          var u = new ArrayBuffer(a),
            h = new Uint8Array(u);
          for (e = 0; e < c; e += 4)
            (r = n[t.charCodeAt(e)]), (o = n[t.charCodeAt(e + 1)]), (i =
              n[t.charCodeAt(e + 2)]), (s = n[t.charCodeAt(e + 3)]), (h[p++] =
              (r << 2) | (o >> 4)), (h[p++] = ((15 & o) << 4) | (i >> 2)), (h[
              p++
            ] =
              ((3 & i) << 6) | (63 & s));
          return u;
          ...
          for (var e = 0; e < t.length; e++) {
            ...
            if (n.buffer instanceof ArrayBuffer) {
              ...
              if (n.byteLength !== r.byteLength) {
                ...
                o.set(new Uint8Array(r, n.byteOffset, n.byteLength)), (r =
                  o.buffer);
              }
              t[e] = r;
            }
      ...
      (function(e) {
        ...
        function o(t) {
          i.call(this, t), (this.query = this.query || {}), a ||
            (e.___eio || (e.___eio = []), (a = e.___eio)), (this.index =
            a.length);
          var n = this;
          a.push(function(t) {
            n.onData(t);
          }), (this.query.j = this.index), e.document &&
            e.addEventListener &&
            e.addEventListener(
              "beforeunload",
              function() {
        ...
        s(
          ...
          function r() {
            ...
            try {
              ...
              (i = document.createElement("iframe")), (i.name =
                o.iframeId), (i.src = "javascript:0");
            }
          ...
          if (!this.form) {
            ...
            (s.className = "socketio"), (s.style.position =
              "absolute"), (s.style.top = "-1000px"), (s.style.left =
              "-1000px"), (s.target = u), (s.method = "POST"), s.setAttribute(
              "accept-charset",
              "utf-8"
            ), (a.name = "d"), s.appendChild(a), document.body.appendChild(
              s
            ), (this.form = s), (this.area = a);
          }
          (this.form.action = this.uri()), r(), (t = t.replace(
            p,
            "\\\n"
    ...
    function(t, e, n) {
      (function(e) {
        function r(t) {
          var e = t && t.forceBase64;
          e && (this.supportsBinary = !1), (this.perMessageDeflate =
            t.perMessageDeflate), (this.usingBrowserWebSocket =
            h && !t.forceNode), (this.protocols = t.protocols), this
            .usingBrowserWebSocket || (l = o), i.call(this, t);
        }
        var o,
          i = n(22),
          s = n(23),
        ...
        var l = h;
        l || "undefined" != typeof window || (l = o), (t.exports = r), c(
          r,
          i
        ), (r.prototype.name =
          ...
          if (this.check()) {
            ...
            (n.pfx = this.pfx), (n.key = this.key), (n.passphrase = this.passphrase), (n.cert = this.cert), (n.ca = this.ca), (n.ciphers = this.ciphers), (n.rejectUnauthorized = this.rejectUnauthorized), this
              .extraHeaders && (n.headers = this.extraHeaders), this
              .localAddress && (n.localAddress = this.localAddress);
            try {
            ...
            void 0 === this.ws.binaryType && (this.supportsBinary = !1), this.ws
              .supports && this.ws.supports.binary
              ? (
          ...
          this.port &&
            ...
            (t[this.timestampParam] = p()), this.supportsBinary ||
    ...
    function(t, e, n) {
      "use strict";
      function r(t, e, n) {
        (this.io = t), (this.nsp = e), (this.json = this), (this.ids = 0), (this.acks = {}), (this.receiveBuffer = []), (this.sendBuffer = []), (this.connected = !1), (this.disconnected = !0), n &&
          n.query &&
      ...
      s(r.prototype), (r.prototype.subEvents = function() {
        ...
        return (n.options = {}), (n.options.compress =
          !this.flags || !1 !== this.flags.compress), "function" ==
          typeof e[e.length - 1] &&
          (
          ...
          ? this.packet(n)
          : this.sendBuffer.push(n), delete this.flags, this;
      }), (r.prototype.packet = function(t) {
        ...
        u(
          "close (%s)",
          t
        ), (this.connected = !1), (this.disconnected = !0), delete this
          .id, this.emit("disconnect", t);
      }), (r.prototype.onpacket = function(t) {
        if (t.nsp === this.nsp)
          switch (t.type) {
            case i.CONNECT:
        ...
        u("emitting event %j", e), null != t.id &&
          (u("attaching ack callback to event"), e.push(this.ack(t.id))), this
          .connected
          ? l.apply(this, e)
    ...
    function(t, e) {
      function n(t) {
        (t = t || {}), (this.ms = t.min || 100), (this.max =
          t.max || 1e4), (this.factor = t.factor || 2), (this.jitter =
